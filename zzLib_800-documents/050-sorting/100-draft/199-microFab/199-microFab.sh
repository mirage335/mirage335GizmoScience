...
_ _o date --iso-8601
_heading1 'microFab'
_t 'Off-the-shelf microscope and pico projector UV ~365nm photolithography and metrology compact lab tool.
...
_t '>ULANZI WL-1 ZV1   ~$50   ~2x   or any adequate &39;macro lens&#39;
...
_t 'https://www.39dollarglasses.com/'


_heading1 'Webcam'
_t '>MU1003   10MP USB 3.0 Color CMOS C-Mount Microscope Camera with Reduction Lens   ~$309.99
...
_t '*) Spare objectives should be kept for fine work only, in case objectives tend to get degraded.
...
_t '*) Focus - not possible without projection. A mirror finish surface has no visible features for any optical microscope to focus, and will always look like just a blank color.
